...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'hieunh@bkacad.edu.vn',
  ...
  footer:
    'Powered by <a href="https://github.com/huuhieu17/steve-onedrive" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by Steve.',
  ...
  protectedRoutes: ['/Recording', '/Demo/😎Another Private Folder Password 123'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:huuhieu1711@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/huuhieu17',
    },
  ],
